...
<body class="d-flex">
    ...
    <div class="vh-100 d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;"> <a href="/"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li> <a href="<?php echo e(route('category.index')); ?>" class="nav-link text-white"> 
                <i class="bi bi-bookmark-plus-fill"></i>
                    Manage Category
                </a> </li>
            <li> <a href="<?php echo e(route('product.index')); ?>" class="nav-link text-white"> 
                <i class="bi bi-ui-checks-grid"></i>
                    Manage Products
                </a> </li>
            <li> <a href="<?php echo e(route('user.index')); ?>" class="nav-link text-white">
...
<?php /**PATH D:\Project_Laraval\crud_operation\resources\views/layout/app.blade.php ENDPATH**/ ?>